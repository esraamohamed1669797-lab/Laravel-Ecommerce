...
<head>
  ...
  <style>
     حل مشكلة السكرول في صفحة الكوبونات
    html, body {
...
<body class="body">
                        ...
                        <div class="wrap">
                            <div class="header-left">
                                ...
                                <form class="form-search flex-grow">
                                    <fieldset class="name">
                                        <input type="text" placeholder="Search here..." class="search-field__input" name="name"
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="{{ asset('uploads/slides/4.jpg') }}" alt="">
                                                </span>
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Esraa Mohamed</span>
    ...
    <script src="{{asset('js/main.js')}}"></script>
     <script>
$(function() {
$(".search-field__input").on("keyup", function() {
